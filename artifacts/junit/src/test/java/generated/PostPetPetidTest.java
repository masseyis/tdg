...
public class PostPetPetidTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostPetPetidTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_updatePetWithForm_0"),
            Arguments.of("Valid_updatePetWithForm_1"),
            Arguments.of("Boundary_updatePetWithForm_0"),
            Arguments.of("Negative_updatePetWithForm_0"),
            Arguments.of("Negative_updatePetWithForm_1")
        );
    }
}