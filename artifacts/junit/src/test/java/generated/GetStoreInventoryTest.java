...
public class GetStoreInventoryTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetStoreInventoryTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_getInventory_0"),
            Arguments.of("Valid_getInventory_1"),
            Arguments.of("Boundary_getInventory_0"),
            Arguments.of("Negative_getInventory_0"),
            Arguments.of("Negative_getInventory_1")
        );
    }
}