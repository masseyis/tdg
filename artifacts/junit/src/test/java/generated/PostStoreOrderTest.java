...
public class PostStoreOrderTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostStoreOrderTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_placeOrder_0"),
            Arguments.of("Valid_placeOrder_1"),
            Arguments.of("Boundary_placeOrder_0"),
            Arguments.of("Negative_placeOrder_0"),
            Arguments.of("Negative_placeOrder_1")
        );
    }
}