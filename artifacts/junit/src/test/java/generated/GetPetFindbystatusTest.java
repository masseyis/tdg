...
public class GetPetFindbystatusTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetPetFindbystatusTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_findPetsByStatus_0"),
            Arguments.of("Valid_findPetsByStatus_1"),
            Arguments.of("Boundary_findPetsByStatus_0"),
            Arguments.of("Negative_findPetsByStatus_0"),
            Arguments.of("Negative_findPetsByStatus_1")
        );
    }
}