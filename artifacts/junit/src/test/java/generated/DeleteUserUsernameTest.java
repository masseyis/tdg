...
public class DeleteUserUsernameTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = DeleteUserUsernameTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_deleteUser_0"),
            Arguments.of("Valid_deleteUser_1"),
            Arguments.of("Boundary_deleteUser_0"),
            Arguments.of("Negative_deleteUser_0"),
            Arguments.of("Negative_deleteUser_1")
        );
    }
}