...
public class GetUserUsernameTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetUserUsernameTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_getUserByName_0"),
            Arguments.of("Valid_getUserByName_1"),
            Arguments.of("Boundary_getUserByName_0"),
            Arguments.of("Negative_getUserByName_0"),
            Arguments.of("Negative_getUserByName_1")
        );
    }
}