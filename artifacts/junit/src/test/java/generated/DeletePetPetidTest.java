...
public class DeletePetPetidTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = DeletePetPetidTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_deletePet_0"),
            Arguments.of("Valid_deletePet_1"),
            Arguments.of("Boundary_deletePet_0"),
            Arguments.of("Negative_deletePet_0"),
            Arguments.of("Negative_deletePet_1")
        );
    }
}