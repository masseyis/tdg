...
public class GetPetFindbytagsTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetPetFindbytagsTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_findPetsByTags_0"),
            Arguments.of("Valid_findPetsByTags_1"),
            Arguments.of("Boundary_findPetsByTags_0"),
            Arguments.of("Negative_findPetsByTags_0"),
            Arguments.of("Negative_findPetsByTags_1")
        );
    }
}