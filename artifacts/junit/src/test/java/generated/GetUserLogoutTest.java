...
public class GetUserLogoutTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetUserLogoutTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_logoutUser_0"),
            Arguments.of("Valid_logoutUser_1"),
            Arguments.of("Boundary_logoutUser_0"),
            Arguments.of("Negative_logoutUser_0"),
            Arguments.of("Negative_logoutUser_1")
        );
    }
}