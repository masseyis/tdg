...
public class PostUserCreatewitharrayTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostUserCreatewitharrayTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_createUsersWithArrayInput_0"),
            Arguments.of("Valid_createUsersWithArrayInput_1"),
            Arguments.of("Boundary_createUsersWithArrayInput_0"),
            Arguments.of("Negative_createUsersWithArrayInput_0"),
            Arguments.of("Negative_createUsersWithArrayInput_1")
        );
    }
}