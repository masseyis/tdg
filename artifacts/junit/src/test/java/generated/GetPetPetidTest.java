...
public class GetPetPetidTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetPetPetidTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_getPetById_0"),
            Arguments.of("Valid_getPetById_1"),
            Arguments.of("Boundary_getPetById_0"),
            Arguments.of("Negative_getPetById_0"),
            Arguments.of("Negative_getPetById_1")
        );
    }
}