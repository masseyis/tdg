...
public class PostUserTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostUserTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_createUser_0"),
            Arguments.of("Valid_createUser_1"),
            Arguments.of("Boundary_createUser_0"),
            Arguments.of("Negative_createUser_0"),
            Arguments.of("Negative_createUser_1")
        );
    }
}