...
public class GetStoreOrderOrderidTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetStoreOrderOrderidTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_getOrderById_0"),
            Arguments.of("Valid_getOrderById_1"),
            Arguments.of("Boundary_getOrderById_0"),
            Arguments.of("Negative_getOrderById_0"),
            Arguments.of("Negative_getOrderById_1")
        );
    }
}