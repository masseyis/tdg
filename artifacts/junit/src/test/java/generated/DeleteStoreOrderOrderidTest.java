...
public class DeleteStoreOrderOrderidTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = DeleteStoreOrderOrderidTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_deleteOrder_0"),
            Arguments.of("Valid_deleteOrder_1"),
            Arguments.of("Boundary_deleteOrder_0"),
            Arguments.of("Negative_deleteOrder_0"),
            Arguments.of("Negative_deleteOrder_1")
        );
    }
}