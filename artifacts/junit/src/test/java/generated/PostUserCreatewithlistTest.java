...
public class PostUserCreatewithlistTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostUserCreatewithlistTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_createUsersWithListInput_0"),
            Arguments.of("Valid_createUsersWithListInput_1"),
            Arguments.of("Boundary_createUsersWithListInput_0"),
            Arguments.of("Negative_createUsersWithListInput_0"),
            Arguments.of("Negative_createUsersWithListInput_1")
        );
    }
}