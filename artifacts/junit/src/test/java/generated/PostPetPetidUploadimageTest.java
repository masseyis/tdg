...
public class PostPetPetidUploadimageTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostPetPetidUploadimageTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_uploadFile_0"),
            Arguments.of("Valid_uploadFile_1"),
            Arguments.of("Boundary_uploadFile_0"),
            Arguments.of("Negative_uploadFile_0"),
            Arguments.of("Negative_uploadFile_1")
        );
    }
}