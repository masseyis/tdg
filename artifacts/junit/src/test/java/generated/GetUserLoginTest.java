...
public class GetUserLoginTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetUserLoginTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_loginUser_0"),
            Arguments.of("Valid_loginUser_1"),
            Arguments.of("Boundary_loginUser_0"),
            Arguments.of("Negative_loginUser_0"),
            Arguments.of("Negative_loginUser_1")
        );
    }
}