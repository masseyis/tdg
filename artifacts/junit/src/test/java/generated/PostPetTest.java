...
public class PostPetTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PostPetTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_addPet_0"),
            Arguments.of("Valid_addPet_1"),
            Arguments.of("Boundary_addPet_0"),
            Arguments.of("Negative_addPet_0"),
            Arguments.of("Negative_addPet_1")
        );
    }
}