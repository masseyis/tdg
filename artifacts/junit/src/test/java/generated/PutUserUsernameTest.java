...
public class PutUserUsernameTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = PutUserUsernameTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_updateUser_0"),
            Arguments.of("Valid_updateUser_1"),
            Arguments.of("Boundary_updateUser_0"),
            Arguments.of("Negative_updateUser_0"),
            Arguments.of("Negative_updateUser_1")
        );
    }
}