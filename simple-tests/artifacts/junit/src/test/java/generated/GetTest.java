...
public class GetTest extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetTest.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_listVersionsv2_0"),
            Arguments.of("Boundary_listVersionsv2_0"),
            Arguments.of("Negative_listVersionsv2_0")
        );
    }
}