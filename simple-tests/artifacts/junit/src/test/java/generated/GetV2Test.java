...
public class GetV2Test extends BaseTest {
    ...
    static void loadTestData() throws Exception {
        InputStream inputStream = GetV2Test.class.getClassLoader()
    ...
    static Stream<Arguments> provideTestCases() {
        return Stream.of(
            Arguments.of("Valid_getVersionDetailsv2_0"),
            Arguments.of("Boundary_getVersionDetailsv2_0"),
            Arguments.of("Negative_getVersionDetailsv2_0")
        );
    }
}